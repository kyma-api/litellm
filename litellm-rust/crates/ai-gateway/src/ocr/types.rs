...
use litellm_core::auth::{AuthSession, TokenProvider};
...
pub(crate) struct PreparedOcrRequest {
    ...
    pub(crate) external_token_provider: Option<Arc<dyn TokenProvider>>,
...
pub(crate) struct ProviderOcrRequest {
    ...
    pub(crate) optional_params: Map<String, Value>,
    pub(crate) upstream_headers: reqwest::header::HeaderMap,
    pub(crate) auth_session: AuthSession,
    pub(crate) timeout: Option<Duration>,
}
